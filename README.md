...
Unlike d810-ng, I do not refactor the code. I do fixes only.
...
Place as `plugins/D810.py` and `plugins/d810`. Other files like `README.MD` may be omitted at will.
